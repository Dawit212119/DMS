...
export const ProjectScalarFieldEnumSchema = z.enum(['id','projectName','clientName','location','startData','dueData','progress','createdAt','updatedAt']);
...
export const DocumentsScalarFieldEnumSchema = z.enum(['id','name','date','projectId']);

export const TheIncomingLetterScalarFieldEnumSchema = z.enum(['id','sender','subject','priority','status','projectId','createdAt','updatedAt']);

export const TheOutgoingLetterScalarFieldEnumSchema = z.enum(['id','recipent','subject','status','priority','createdAt','projectId']);
...
export const ProjectWhereInputSchema: z.ZodType<Prisma.ProjectWhereInput> = z.object({
  ...
  startData: z.union([ z.lazy(() => DateTimeFilterSchema),z.coerce.date() ]).optional(),
...
export const ProjectOrderByWithRelationInputSchema: z.ZodType<Prisma.ProjectOrderByWithRelationInput> = z.object({
  ...
  startData: z.lazy(() => SortOrderSchema).optional(),
...
export const ProjectScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.ProjectScalarWhereWithAggregatesInput> = z.object({
  ...
  startData: z.union([ z.lazy(() => DateTimeWithAggregatesFilterSchema),z.coerce.date() ]).optional(),
...
export const ProjectUpdateInputSchema: z.ZodType<Prisma.ProjectUpdateInput> = z.object({
  ...
  startData: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
